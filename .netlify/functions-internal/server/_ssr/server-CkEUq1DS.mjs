...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BBk79MWi.mjs");
...
const manifest = {
  "36530dd13befeb732fee969d18ca06efc81e5a6873e4b7a64f4e4f13a0cf04d9": {
    functionName: "listCollections_createServerFn_handler",
    importer: () => import("./products.functions-D4nbwdbb.mjs")
  },
  "42b7e30546b5a7c03d1813ff23502b3d12d813b160186ef0bd9c4bac61108f25": {
    functionName: "createSupportTicket_createServerFn_handler",
    importer: () => import("./support.functions-CNZNxWgq.mjs")
  },
  "51ac02698006d191c28969bc655e6f6227d772d713f4d3615f2c72940208c22e": {
    functionName: "listMyOrders_createServerFn_handler",
    importer: () => import("./checkout.functions-Cw7LfqJh.mjs")
  },
  "51ad93d03c52987e0e52d0164e41771f8765a8919d8a537367eaf795dff9b9d8": {
    functionName: "listProducts_createServerFn_handler",
    importer: () => import("./products.functions-D4nbwdbb.mjs")
  },
  "537c5b5eac7a9657f797c4c7df0b3e0c7c9c3e8d42e66d55520193729b08c440": {
    functionName: "placeOrder_createServerFn_handler",
    importer: () => import("./checkout.functions-Cw7LfqJh.mjs")
  },
  "659167231f60bd1ad19ce2d40f4476e725faabff9a9f488f2fa06db75e35ea5d": {
    functionName: "saveCustomDesign_createServerFn_handler",
    importer: () => import("./cart.functions-YBBlB5Z_.mjs")
  },
  "6f602d242a211117c1c6bdd7e559c6a568fab6fb032c40b2131f45c58acaed5a": {
  ...
  "7505f42c80ef23062941d0d756dc981ff786a046ef5488fd334be4d47ac76d04": {
    functionName: "getMyOrderByCode_createServerFn_handler",
    importer: () => import("./checkout.functions-Cw7LfqJh.mjs")
  },
  "7d53124a31f98b85a93a534a154a80a64aff3ad6e9160b0b533490223d9a5d18": {
    functionName: "validateCoupon_createServerFn_handler",
    importer: () => import("./checkout.functions-Cw7LfqJh.mjs")
  },
  "83ff112a2fb04e6c5e01c31120c559b10d7eb9057cd3b654aac6abd03c4c3902": {
    functionName: "listTestimonials_createServerFn_handler",
    importer: () => import("./products.functions-D4nbwdbb.mjs")
  },
  ...
  "9de945013b6610084706a3967af08574aac1fc77d63437cb5bffa7714a5726c9": {
    functionName: "addProductToCart_createServerFn_handler",
    importer: () => import("./cart.functions-YBBlB5Z_.mjs")
  },
  "a28caa4bb5dc87b6586f87b412c05650c9a19ff351492cbc7feef1f8e00254ef": {
    functionName: "listFaq_createServerFn_handler",
    importer: () => import("./products.functions-D4nbwdbb.mjs")
  },
  ...
  "df4ad356d9c1425ec33771cae468d7a538cdffa5ec4ef0d1e0bba725fa824e54": {
    functionName: "getStudioData_createServerFn_handler",
    importer: () => import("./products.functions-D4nbwdbb.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-DziuQjSF.mjs").then((n) => n.w),
    import("./start-BXqXLNXv.mjs"),
